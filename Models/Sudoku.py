...
try:
    ...
    from sklearn.ensemble import IsolationForest, RandomForestClassifier, RandomForestRegressor, HistGradientBoostingRegressor
...
# PKL MODEL HELPERS
# =====================================================
_PKL_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Models")
...
def _train_ml_models(self, force=False):
    ...
    if _protect_gbm:
        ...
        # Hanya timpa GBM.pkl jika CV balanced_accuracy murni lebih tinggi dari notebook
    ...
    if _protect_multi:
        ...
        # Hanya timpa PKL jika CV R² murni lebih tinggi dari R² model notebook
